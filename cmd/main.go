...
import (
	...
	"github.com/mortenolsen/dns-operator/internal/controller"
	webhookv1alpha1 "github.com/mortenolsen/dns-operator/internal/webhook/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1db3bf29.homelab.mortenolsen.pro",
