...
*/}}
{{- define "dns-operator.webhookServiceName" -}}
webhook-service
{{- end }}
...
*/}}
{{- define "dns-operator.metricsServiceName" -}}
{{- printf "%s-metrics-service" (include "dns-operator.fullname" .) }}
{{- end }}
